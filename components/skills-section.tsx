...
const skills = [
  ...
  { name: "TypeScript", icon: <Code className="h-6 w-6" />, color: "bg-blue-100 text-blue-700" },
  ...
  { name: "REST APIs", icon: <Globe className="h-6 w-6" />, color: "bg-violet-100 text-violet-600" },

  { name: "Jira", icon: <Layers className="h-6 w-6" />, color: "bg-sky-100 text-sky-700" },

  { name: "NVDA", icon: <Terminal className="h-6 w-6" />, color: "bg-indigo-100 text-indigo-700" },

  { name: "ePUB", icon: <FileJson className="h-6 w-6" />, color: "bg-lime-100 text-lime-700" },
]
